...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            ...
            <asp:TextBox ID="TextBox6" runat="server" style="z-index: 1; left: 196px; top: 256px; position: absolute"></asp:TextBox>
        </p>
        <p>
        ...
        <p>
            ...
            <asp:TextBox ID="TextBox14" runat="server" style="z-index: 1; left: 196px; top: 364px; position: absolute"></asp:TextBox>
        </p>
        <p>
                       <asp:Label ID="lblDateAdded" runat="server" style="z-index: 1; left: 28px; top: 419px; position: absolute" Text="DateAdded"></asp:Label>
        </p>
        <p>
            <asp:TextBox ID="TextBox9" runat="server" style="z-index: 1; left: 196px; top: 422px; position: absolute"></asp:TextBox>
